...
class TFG_Reset_Token_CPT {
    ...
    // Register the 'reset_tokens' CPT (non-public, admin-only UI)
    public static function register_cpt(): void {
        $caps = [
            // Map to standard admin caps; customize if you want a custom role
        ...
        register_post_type('reset_tokens', [
            ...
            'show_ui'            => true, 
            'show_in_menu'       => false,      // hidden from sidebar (you can add a custom submenu elsewhere)
            'show_in_rest'       => false,      // keep out of REST by default
            'supports'           => ['title'],  // ACF handles the rest
    ...
    // Register ACF fields for reset_tokens
        ...
        acf_add_local_field_group([
            ...
            'fields' => [
                ...
                [
                    ...
                    'return_format'  => 'Y-m-d H:i:s', // matches your system choice
                ],
                [
                    'key'           => 'field_is_used',
